        ...
        <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            <div className="md:col-span-3">
                ...
                {contactInfo.map((info) => (
                    <Card key={info.title} className="bg-card/80 backdrop-blur-sm text-card-foreground border-l-4 border-accent shadow-sm hover:shadow-lg transition-shadow duration-300">
                        <CardHeader className="flex flex-row items-center gap-4 p-4">
                            ...
                            <div>
                                <CardTitle className='font-headline text-xl text-foreground'>{info.title}</CardTitle>
